...
const PAYMENTS_COLUMNS = [
  ...
  /** -------------------- FETCH PAYMENTS ------------------- */
    ...
    try {
        const params = `${selectedOffice}#10#${selectedActionType}#${selectedFromDate}#${selectedToDate}#${(page-1)*PAGE_LIMIT + 1}#${PAGE_LIMIT}`;
...
export default LoverDonationReport;
